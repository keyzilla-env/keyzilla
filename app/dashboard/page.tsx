...
export default function DashboardPage() {
    ...
    useEffect(() => {
        if (results) {
            ...
            if (lastItem && typeof lastItem === 'object' && 'totalCount' in lastItem && typeof lastItem.totalCount === 'number') {
        ...
        <div className="container mx-auto py-8">
            ...
            <div className="mt-6">
                {isLoading ? (
                    ...
                    <>
                        <ProjectGrid
                            projects={results.slice(currentPage * ITEMS_PER_PAGE, (currentPage + 1) * ITEMS_PER_PAGE)}
                            ...
                            <PaginationContent>
                                ...
                                {[...Array(totalPages)].map((_, index) => (
                                    <PaginationItem key={index}>
                                        <PaginationLink
                                            ...
                                            className={index === 1 && results.length < 9 ? 'pointer-events-none opacity-50' : ''}
                                        >
                                            {index + 1}
                                        </PaginationLink>
                                    </PaginationItem>
                                ...
                                <PaginationItem>
                                    <PaginationNext
                                        ...
                                        aria-disabled={currentPage === totalPages - 1 || results.length < 9}
                                        className={(currentPage === totalPages - 1 || results.length < 9) ? 'pointer-events-none opacity-50' : ''}
                                    />
                                </PaginationItem>
                            </PaginationContent>
                        </Pagination>
